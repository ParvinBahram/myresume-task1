...
function CheckShowModal(){
  ...
  if(result.isValid){
    ...
    modal.classList.remove("border-2", "border-red-500");
    modal.classList.add("border-2", "border-green-500"); 

  }else{
     modalMessage.innerHTML=`${"❌"}${"<br>"}${result.errorMessage.join("<br>")}`;
       modal.classList.remove("border-2", "border-green-500");
       modal.classList.add("border-2", "border-red-500");
