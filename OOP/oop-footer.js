...
class InfoSection {
  ...
  render() {
    ...
    container.className = "lg:2/5";

    container.innerHTML = `
      <h2 class="text-2xl font-semibold ">
        برای تماس با ما از طریق راههای زیر در ارتباط باشید
      </h2>
      <div class="mt-6 space-y-8 md:mt-8 ">
        <p class="flex items-start mx-2">
          <i data-lucide="map-pin" class="text-purple-700"></i>
          <span class="mx-2 truncate w-72 ">
            ایران، تهران، خیابان ششم، پلاک 14
          </span>
        </p>
        <p class="flex items-start mx-2">
          <i data-lucide="phone" class=" text-purple-700"></i>
          <a href="tel:'09332306006'" class="mx-2 truncate w-72 ">09332306006</a>
        </p>
        <p class="flex items-start mx-2">
          <i data-lucide="mail" class=" text-purple-700"></i>
          <a href="mailto:'email@example.com'" class="mx-2 truncate w-72">email@example.com</a>
        </p>
      </div>
      <div class="mt-6 w-80 md:mt-8">
        <h2 class="text-2xl">ما در شبکه های اجتماعی</h2>
        <div class="flex mt-4 items-center px-2">
          <a href="https://instagram.com/parvin.bahram.sh" aria-label="instagram icon" target="_blank" class="mx-1.5 px-2 transition-colors duration-300 transform" >
            <i data-lucide="instagram" class="h-8 w-8 text-pink-700" aria-hidden="true"></i>
          </a>
          <a href="https://t.me/parvinbahram" aria-label="telegram icon" target="_blank" class="mx-1.5 px-2 transition-colors duration-300 transform">
          ...
          <a href="https://wa.me/989332306006" aria-label="whatsapp icon" target="_blank" class="mx-1.5 px-2 duration-300 transform">
             <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="40" height="40" viewBox="0 0 48 48">
...
document.addEventListener("DOMContentLoaded",()=>{
  ...
  contactSection.appendChild(info.render());
  contactSection.appendChild(form.render());
  form.init();
   lucide.createIcons();
